...
function _login($forward = '') {
	...
	if (!empty($record)) {
		...
		if($forward=="./index.php?c=home&a=welcome&do=system&" || $forward=="./index.php?c=home&a=welcome&do=system_home&"){
			$forward = "./index.php?c=home&a=welcome&do=ext&m=ewei_shopv2&uniacid=1";
        }
