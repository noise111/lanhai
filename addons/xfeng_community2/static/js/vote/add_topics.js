...
$(function(){
    ...
    $(document).on('click','.qs-handle',function(){
        ...
        if(_type == 'topics-radio' || _type == 'topics-checkbox'){
            ...
            // setBox +='<th width="30%">选项说明</th>';
            // setBox +='<th width="30%">图片</th>';
            ...
            for(var i=0;i<choice_item.size();i++){
                ...
                // setBox +='<td class="p-l-10"><input class="form-control-k" value="'+choice_item.eq(i).find('.choice-text span').text()+'" placeholder="选项说明"></td>';
                // if(choice_item.eq(i).hasClass('has-img')){
                //     setBox += '<td><a class="choice-img uped"><i class="fa fa-photo"></i></a></td>';
                // }else{
                //     setBox += '<td><a class="choice-img"><i class="fa fa-photo"></i></a></td>';
                // }
    ...
    $(document).on('click','.addChoice',function(){
        ...
        // _tr +='<td><a class="choice-img"><i class="fa fa-photo"></i></a></td>';
        // _tr +='<td><a href="javascript:" class="move-up" title="向上"><img src="../addons/xfeng_community/static/img/vote/top.png" alt="" width="15px"></a>';
        // _tr +='<a href="javascript:" class="m-l-20 move-down" title="向下"><img src="../addons/xfeng_community/static/img/vote/bot.png" alt="" width="15px"></a>';
