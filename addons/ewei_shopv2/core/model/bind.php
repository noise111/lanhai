...
class Bind_EweiShopV2Model
{
	...
	public function merge($a = array(), $b = array())
	{
        ...
        $diycommissiondata = !empty($b['diycommissiondata']) && empty($a['diycommissiondata']) ? $b['diycommissiondata'] : $a['diycommissiondata'];
        $diycommissionfields = !empty($b['diycommissionfields']) && empty($a['diycommissionfields']) ? $b['diycommissionfields'] : $a['diycommissionfields'];
        ...
        if(isset($diycommissiondata)){
            $arr['diycommissiondata'] = $diycommissiondata;
        }
        if(isset($diycommissionfields)){
            $arr['diycommissionfields'] = $diycommissionfields;
        }
