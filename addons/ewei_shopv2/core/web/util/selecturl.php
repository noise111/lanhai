...
class Selecturl_EweiShopV2Page extends WebPage 
{
	...
	public function main() 
	{
		...
		{
			$allUrls[0]["list"][] = array( "name" => "区域运营中心", "url" => mobileUrl("abonus", $full), "url_wxapp" => "" );
		}
		$allUrls[0]["list"][] = array( "name" => "平台街", "url" => mobileUrl("", NULL, $full), "url_wxapp" => "/pages/changce/merch/index" );
		$allUrls[0]["list"][] = array( "name" => "特约零售商入住", "url" => mobileUrl("", NULL, $full), "url_wxapp" => "/pages/changce/merch/apply" );		
