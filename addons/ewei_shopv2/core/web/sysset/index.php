...
class Index_EweiShopV2Page extends WebPage 
{
	...
	public function payset() 
	{
		...
		if( empty($payments) ) 
		{
			...
			{
				$default = array( "uniacid" => $_W["uniacid"], "title" => "微信支付子特约零售商", "type" => 1, "appid" => $sec["appid_sub"], "mch_id" => $sec["mchid_sub"], "sub_appid" => $sec["sub_appid_sub"], "sub_appsecret" => $_W["account"]["secret"], "sub_mch_id" => $sec["sub_mchid_sub"], "apikey" => $sec["apikey_sub"], "cert_file" => $sec["sub"]["cert"], "key_file" => $sec["sub"]["key"], "root_file" => $sec["sub"]["root"], "createtime" => TIMESTAMP );
				$payments[] = $default;
				pdo_insert("ewei_shop_payment", $default);
