...
if( $_W["ispost"] ) 
{
	...
	$data = array( 
        ...
        "onlinestoreget" => floatval($_GPC['onlinestoreget']),
        "onlinehomeget" => floatval($_GPC['onlinehomeget']),
        "storeget" => floatval($_GPC['storeget']),
        "salerfirst" => floatval($_GPC['salerfirst']),
        "salermore" => floatval($_GPC['salermore']),
        "agentonline" => floatval($_GPC['agentonline']),
//        "agenthome" => floatval($_GPC['agenthome']),
        "teambenefit" => floatval($_GPC['teambenefit']),
