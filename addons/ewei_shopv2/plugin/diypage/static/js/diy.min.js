    ...
    modal.initNavs = function () {
        ...
        $("#navs nav").unbind('click').click(function () {
            ...
            if (id == 'merchgroup' && !modal.plugins.merch) {
                tip.msgbox.err("未开启特约零售商，禁止添加此元素！");
                return
            }
    ...
    modal.getNavs = function () {
        modal.navs = {
            ...
            merchgroup: {
                ...
                data: {
                    C0123456789101: {name: "特约零售商名称A", desc: "这里是特约零售商A的介绍", thumb: "", merchid: ""},
                    C0123456789102: {name: "特约零售商名称B", desc: "这里是特约零售商B的介绍", thumb: "", merchid: ""},
                    C0123456789103: {name: "特约零售商名称C", desc: "这里是特约零售商C的介绍", thumb: "", merchid: ""}
                }
            },
            audio: {
                name: "音频播放",
