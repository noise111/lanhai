			...
			if (($message_type == TM_ABONUS_PAY) && empty($usernotice['abonus_pay'])) {
				...
				if ($tm['is_advanced']) {
					...
					if ($data['aagenttype'] == 1) {
						...
						$paytitle = ((empty($tm['paytitle1']) ? '省级运营中心分红发放通知' : $tm['paytitle1']));
						...
						$paytitle = ((empty($tm['paytitle2']) ? '市级运营中心分红发放通知' : $tm['paytitle2']));
						...
						$paytitle = ((empty($tm['paytitle3']) ? '区级运营中心分红发放通知' : $tm['paytitle3']));
					...
					$message = array(
						...
						'keyword1' => array('title' => '任务名称', 'value' => '区域运营中心分红发放通知', 'color' => '#000000'),

						'keyword2' => array('title' => '任务类型', 'value' => '您的区域运营中心分红已发放', 'color' => '#000000'),
				...
				if ($tm['is_advanced']) {
					...
					if (($data['aagenttype'] == 1) && empty($tm['abonus_upgrade1_close_advanced'])) {
						...
						$upgradetitle = ((empty($tm['upgradetitle1']) ? '省级运营中心等级升级通知' : $tm['upgradetitle1']));
						...
						$upgradetitle = ((empty($tm['upgradetitle2']) ? '市级运营中心等级升级通知' : $tm['upgradetitle2']));
						...
						$upgradetitle = ((empty($tm['upgradetitle3']) ? '区级运营中心等级升级通知' : $tm['upgradetitle3']));
					...
					$message = array(
						...
						'keyword2' => array('title' => '任务类型', 'value' => '您的区域运营中心等级从' . $data['oldlevel']['levelname'] . '升级为' . $data['newlevel']['levelname'] . '特此通知！', 'color' => '#000000'),
				...
				if ($tm['is_advanced']) {
					...
					$message = array(
						...
						'keyword1' => array('title' => '任务名称', 'value' => '成为区域运营中心通知', 'color' => '#000000'),
					...
					$datas[] = array('name' => '运营中心级别', 'value' => $aagenttype);

					$datas[] = array('name' => '运营中心区域', 'value' => $data['aagentareas']);
					...
					$message = str_replace('[运营中心级别]', $aagenttype, $message);

					$message = str_replace('[运营中心区域]', $data['aagentareas'], $message);

					$msg = array(

						'keyword1' => array('value' => (!(empty($tm['becometitle'])) ? $tm['becometitle'] : '成为区域运营中心通知'), 'color' => '#73a68d'),
...

		{
			...
			if (($leveltype == 4) || ($leveltype == 5)) {
				...
				if (empty($oldlevel['id'])) {
					...
					$oldlevel = array('levelname' => (empty($set['levelname']) ? '普通运营中心' : $set['levelname']), 'bonus' => $set['bonus']);
