...

{
...

		{
...

			{
...

				{
					...
					plog('abonus.level.edit', '修改运营中心默认等级' . $updatecontent);
...

				{
					...
					plog('abonus.level.edit', '修改运营中心等级 ID: ' . $id . $updatecontent);
...

			{
				...
				plog('abonus.level.add', '添加运营中心等级 ID: ' . $id);
...

	{
...

		{
			...
			plog('abonus.level.delete', '删除运营中心等级 ID: ' . $id . ' 等级名称: ' . $item['levelname']);
