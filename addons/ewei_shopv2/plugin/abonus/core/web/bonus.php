...

{
...

	{
...

		{
			...
			m('excel')->export($list, array( 'title' => '结算单-' . time(), 'columns' => array( array('title' => 'ID', 'field' => 'id', 'width' => 12), array('title' => '结算类型', 'field' => 'paytype', 'width' => 12), array('title' => '单号', 'field' => 'billno', 'width' => 24), array('title' => '日期', 'field' => 'days', 'width' => 12), array('title' => '订单数', 'field' => 'ordercount', 'width' => 12), array('title' => '订单金额', 'field' => 'ordermoney', 'width' => 12), array('title' => '运营中心数', 'field' => 'agentcount', 'width' => 12), array('title' => '预计分红', 'field' => 'bonusmoney', 'width' => 12), array('title' => '预计分红', 'field' => 'bonusmoney', 'width' => 12), array('title' => '最终分红', 'field' => 'bonusmoney_send', 'width' => 12), array('title' => '状态', 'field' => 'statusstr', 'width' => 12) ) ));
...

	{
...

		{
			...
			plog('abonus.bonus.detail.export', '导出结算单运营中心数据 ID: ' . $data['id'] . ' 单号: ' . $data['billno']);
...

	{
		...
		plog('abonus.bonus.delete', '删除结算单 ID:' . $data . ' 单号: ' . $data['billno'] . ' <br/>分红:  省级-' . $data['bonusmoney_pay1'] . ' 市级-' . $data['bonusmoney_pay2'] . ' 区级-' . $data['bonusmoney_pay3'] . ' <br/>运营中心人数:  省级-' . $data['aagentcount1'] . ' 市级-' . $data['aagentcount2'] . ' 区级-' . $data['aagentcount3']);
...

	{
...

		{
			...
			plog('abonus.bonus.build', '创建结算单 ID:' . $billid . ' 单号: ' . $bill['billno'] . ' 分红金额: ' . $bill['bonusmoney_pay'] . ' 区域运营中心人数:  ' . $bill['partnercount']);
...

	{
...

		{
			...
			$result = m('finance')->pay($aagent['openid'], $moneytype, $pay, $aagent['payno'], '区域运营中心分红', false);
