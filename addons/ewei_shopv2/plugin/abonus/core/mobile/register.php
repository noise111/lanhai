...

{
...

	{
...

		{
			...
			$apply_set['applytitle'] = '区域运营中心申请协议';
...

		{
...

			{
                ...
                if(!empty($area)){
                    list($code_province, $code_city, $code_area) = explode(' ', $_GPC['area']);
                    $area_code = m('common')->getAreaCode($code_province, $code_city, $code_area);
                    $data['agent_area_code'] = empty($area_code['area']) ? '' : $area_code['area'];
                }
