	...
	protected function post()
	{
		...
		if ($_W['ispost']) {
			...
			if (!empty($id)) {
				...
				plog('poster.edit', '修改超级海报 ID: ' . $id . '<br>' . ($data['isopen'] ? '允许非事业合伙人生成自己的海报 -- 是<br>' : '允许非事业合伙人生成自己的海报 -- 否<br>') . ($data['bedown'] ? '扫码关注成为下线 -- 是<br>' : '扫码关注成为下线 -- 否<br>') . ($data['beagent'] ? '扫码关注成为事业合伙人 -- 是' : '扫码关注成为事业合伙人 -- 否'));
			}
			else {
				pdo_insert('ewei_shop_poster', $data);
				$id = pdo_insertid();
				plog('poster.add', '添加超级海报 ID: ' . $id . '<br>' . ($data['isopen'] ? '允许非事业合伙人生成自己的海报<br>' : '不允许非事业合伙人生成自己的海报<br>') . ($data['bedown'] ? '扫码关注成为下线 -- 是<br>' : '扫码关注成为下线 -- 否<br>') . ($data['beagent'] ? '扫码关注成为事业合伙人 -- 是' : '扫码关注成为事业合伙人 -- 否'));
			}
