										...
										else 
										{
											if( $message_type == TM_COMMISSION_APPLYMONEY && empty($usernotice["commission_applymoney"]) ) 
											{
												if( $tm["is_advanced"] ) 
												{
													...
													$message = array( "first" => array( "value" => "亲爱的管理员您有一条新的" . $set["texts"]["commission"] . "提现申请", "color" => "#ff0000" ), "keyword1" => array( "title" => "业务类型", "value" => "佣金提现", "color" => "#000000" ), "keyword2" => array( "title" => "业务状态", "value" => "特约零售商名称:" . $member["nickname"], "color" => "#000000" ), "keyword3" => array( "title" => "业务内容", "value" => "佣金提现:" . $data["commission"] . "元", "color" => "#000000" ), "remark" => array( "value" => "\n感谢您的支持", "color" => "#000000" ) );
													$toopenid = $tm["openid"];
													$datas[] = array( "name" => "昵称", "value" => $member["nickname"] );
													$datas[] = array( "name" => "时间", "value" => $time );
													$datas[] = array( "name" => "金额", "value" => $data["commission"] );
