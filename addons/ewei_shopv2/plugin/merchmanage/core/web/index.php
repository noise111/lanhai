...
class Index_EweiShopV2Page extends PluginWebPage
{
	public function main()
	{
		...
		if (empty($result)) {
			...
			$sql = 'INSERT INTO ' . tablename('ewei_shop_plugin') . ' (`displayorder`,`identity`,`name`,`version`,`author`,`status`,`category`) VALUES(' . $displayorder . ',\'merchmanage\',\'特约零售商手机端\',\'1.0\',\'tonychemeng\',\'1\',\'biz\');';
			pdo_query($sql);
		}
