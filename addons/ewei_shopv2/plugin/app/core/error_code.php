...
class AppError 
{
    ...
    public static $StoreNotValid = -11;
    public static $MerchNotValid = -12;
    public static $AgentNotValid = -13;
    public static $SalerNotValid = -14;
    public static $NoPermission = -15;
    ...
    public static $QrcodeNotFound = 20004;
    public static $QrcodeIsUsed = 20005;
    public static $QrcodeisUsedOther = 20006;
    ...
    public static $OrderOnlyVerify = 50020;
    ...
    public static $OrderCreateNoSaler = 50208;
	...
	public static $errCode = array( 
        ...
        "-15"                  => "你没有对应的权限",
        "处理成功", 
        "18446744073709551615" => "系统内部错误", 
        "18446744073709551614" => "参数错误", 
        "18446744073709551613" => "未登录", 
        "18446744073709551607" => "插件未找到",
        "18446744073709551610" => "错误的请求", 
        "90000" => "验证码错误", 
        "90001" => "验证码失效", 
        "10000" => "登录失败", 
        "10001" => "登录失效", 
