...
function app_json($result = NULL) 
{
	...
	$ret["sysset"] = array( "shopname" => $_W["shopset"]["shop"]["name"], "shoplogo" =>  tomedia($_W["shopset"]["shop"]["logo"]), "description" => $_W["shopset"]["shop"]["description"], "share" => $_W["shopset"]["share"], "texts" => array( "credit" => $_W["shopset"]["trade"]["credittext"], "money" => $_W["shopset"]["trade"]["moneytext"] ), "isclose" => $_W["shopset"]["app"]["isclose"] );
