...
class Address_EweiShopV2Page extends AppMobilePage 
{
	...
	public function submit() 
	{
        ...
        $area_code = m('common')->getAreaCode($data['province'], $data['city'], $data['area']);
        $data['province_code'] = $area_code['province'];
        $data['city_code'] = $area_code['city'];
        $data['area_code'] = $area_code['area'];
