...
class Index_EweiShopV2Page extends AppMobilePage 
{
	...
	public function cacheset() 
	{
		...
		if( empty($noset) ) 
		{
			$arr["sysset"] = array( "shopname" => $_W["shopset"]["shop"]["name"], "shoplogo" => tomedia($_W["shopset"]["shop"]["logo"]), "description" => $_W["shopset"]["shop"]["description"], "share" => $_W["shopset"]["share"], "texts" => array( "credit" => $_W["shopset"]["trade"]["credittext"], "money" => $_W["shopset"]["trade"]["moneytext"] ), "isclose" => $_W["shopset"]["app"]["isclose"] );
    ...
    public function get_rank_data(){
        ...
        $rank_model = m('plugin')->loadModel("rank");
        $list = $rank_model->get_rank_data($id, $type);
        ...
        app_json(array("list" => $list, "my" => $my));
    }
}
?>