...
function referer($default = '') {
	...
	if (!empty($reurl['host']) && !in_array($reurl['host'], array($_SERVER['SERVER_NAME'], 'www.' . $_SERVER['SERVER_NAME'])) && !in_array($_SERVER['SERVER_NAME'], array($reurl['host'], 'www.' . $reurl['host']))) {
